...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red][B]BReeZz Wizard[/B][/COLOR]'
BUILDERNAME = '[COLOR red]BReeZz[/COLOR]'
EXCLUDES = [ADDON_ID, 'repository.breezz']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'http://breezz1.com/wizard/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]BReeZz[/B][/COLOR][COLOR {color2}] Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing BReeZz Wizard.'
...
REPOID = 'repository.breezz'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'http://breezz1.com/breezz/repo/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'http://breezz1.xyz/breezz/repo/repository.breezz/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red][B]BReeZz[/B][/COLOR] Wizard'
# url to image if using Image 424x180
HEADERIMAGE = 'icon.png'
